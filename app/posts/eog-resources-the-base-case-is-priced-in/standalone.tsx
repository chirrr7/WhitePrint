...
export function EogStandalone() {
  useEffect(() => {
    document.body.classList.add("eog-standalone")
    return () => document.body.classList.remove("eog-standalone")
  }, [])

  return (
    <>
      <style jsx global>{`
        body.eog-standalone > header,
        body.eog-standalone > footer {
          display: none;
        }

        body.eog-standalone main {
          padding: 0 !important;
        }
      `}</style>
      <iframe
