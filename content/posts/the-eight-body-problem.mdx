...
displayTitle: "The <em>Eight-Body Problem:</em> The Complete Financial Architecture of the 2026 Iran War"
date: "2026-03-27"
category: "macro"
  ...
  - title: "Hormuz Snapshot"
    rows:
      ...
      - label: "Unbypassable Gap"
        value: "~14–16 Mbpd"
        tone: "negative"
    note: "Bypass infrastructure covers roughly 22–33% of normal Hormuz throughput under wartime conditions."
  - title: "Key Price Levels"
    rows:
      ...
      - label: "US Shale Breakeven"
        value: "~$61/bbl"
        tone: "positive"
    note: "Iran's fiscal breakeven exceeds pre-war Brent, creating structural pressure on regime solvency."
