  ...
  - title: "FY2030 Base Case"
    rows:
      ...
      - label: "ROIC – WACC"
        value: "+0.8%"
        tone: "warning"
    note: "Capex normalizes from 74.6% (FY2026E) to 25.0%. Revenue CAGR ~10.7%. SBC-adj FCF turns positive only in FY2030."
  - title: "Key Risks to Thesis"
    rows:
      - label: "OCI utilization"
        value: "ROIC re-expands if backlog converts at high utilization"
      - label: "Customer funding"
        value: "Customer-funded contracts could reduce Oracle's capital burden"
      - label: "AI demand"
        value: "AI supercycle exceeds expectations, justifying the base"
      - label: "Duration mismatch"
        value: "15–19yr leases vs. shorter customer commitment horizons"
      - label: "OCI sensitivity"
        value: "10% revenue miss collapses gross margin from 32% to 7%"
      - label: "Financing gap"
        value: "~$75B gap forces dilutive equity or credit deterioration"
---
