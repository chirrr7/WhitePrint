...
<StickyLayout>
<StickyTable title="EM Transmission">
  <table>
    <thead>
      <tr>
        <th>Economy</th>
    ...
    <tbody>
      <tr>
        ...
        <td>Importer · 85% of crude</td>
        <td>▼ Severe — INR pressure</td>
      </tr>
      <tr>
        <td><strong>Turkey</strong></td>
        <td>Importer · ~100% of crude</td>
        <td>▼ Severe — Lira amplified</td>
      </tr>
      <tr>
        <td><strong>Colombia</strong></td>
        <td>Exporter · 900k bbl/d</td>
        <td>▲ Positive — COP support</td>
      </tr>
      <tr>
        <td><strong>Brazil</strong></td>
        <td>Net exporter · Petrobras</td>
        <td>▲ Positive — BRL support</td>
      </tr>
    </tbody>
  </table>
</StickyTable>
