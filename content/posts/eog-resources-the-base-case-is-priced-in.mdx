...
stance: "neutral"
conviction: "medium"
stanceThesis: "Base case is in the price at ~$140. Asymmetric upside is conditional on the conflict-up oil path. Below Brent $90, the premium-return reinvestment thesis loses its margin of safety."
status: "active"
bear: 64.58
base: 152.73
bull: 196.42
marketNoteTable:
  stance: "Hold / Scenario-Driven"
  confidence: "Medium"
  horizon: "6-12 months"
  quickAnswer: >-
    Maintain exposure, but do not add aggressively unless the conflict-up oil
    scenario deserves a meaningfully higher weight than the market is assigning.
  whatChangesOurMind: >-
    A cleaner de-escalation that sends oil back toward strip, or a sustained
    conflict-driven oil regime that justifies lifting the conflict-up
  ...
  - title: "Valuation Snapshot"
    rows:
      ...
      - label: "WTI Breakeven"
        value: "$50/bbl"
        tone: "positive"
    note: "Whiteprint March 2026 DCF snapshot. Analytical outputs only, not investment advice."
  - title: "Scenario Weights"
    rows:
      ...
      - label: "Bear"
        value: "20%"
        tone: "negative"
    note: "The key analytical question is whether the conflict-up weight should move materially higher."
  - title: "Core Inputs"
    rows:
      - label: "WACC"
        value: "8.95%"
      ...
      - label: "2026 Capex"
        value: "$6.5B"
reportDownload:
  href: "/models/eog-resources-dcf.xlsx"
  filename: "eog-resources-dcf.xlsx"
  label: "EOG DCF Model"
---
