...
<ResearchTable
  headers={["Scenario", "2026E", "2027E", "2028E", "2029E", "2030E", "2031E", "2032E"]}
  rows={[
  ...
  caption="All figures in billions of dollars. The conflict-up FCF path sits roughly 14% above base throughout the projection period."
/>
  ...
  items={[
    {
      ...
      summary:
        "Geopolitical risk premium supports near-term pricing. $80 mid-cycle reflects Saudi fiscal breakeven and long-run marginal cost of supply. Gas stays near the EIA STEO strip at $2.60 per Mcf. 2026E EBITDA is $15.6 billion and FCF is $6.1 billion.",
    ...
    },
    {
      ...
      summary:
        "Prolonged Gulf supply disruption holds WTI elevated through 2026 and 2027. Gas lifts to $3.00 per Mcf on LNG re-routing and energy-security flows. 2026E EBITDA is $17.0 billion and FCF is $7.0 billion.",
    ...
    },
    {
      ...
      summary:
        "Deeper OPEC+ cuts combine with strong demand and an LNG export boom. Gas reaches $3.20 per Mcf. 2026E EBITDA is $18.3 billion and FCF is $7.7 billion. This requires sustained supply discipline beyond what markets currently price as durable.",
    ...
    },
    {
      ...
      summary:
        "A U.S. recession or sharp global demand contraction breaks WTI to $55. FCF collapses to $1.6 billion. EOG's $50 breakeven still covers the regular dividend, but buybacks stop. Gas falls to $2.20 per Mcf. 2026E EBITDA is $7.8 billion.",
...
<ResearchTable
  headers={["Scenario", "WTI 2026E", "DCF Implied", "EV/EBITDA (5.5x)", "Upside / (Down)", "Prob. Weight"]}
  rows={[
    ["Bear", "$55", "$64.58", "$71.33", "-53.9%", "20%"],
    ["Base", "$90", "$152.73", "$150.79", "+9.0%", "45%"],
    ["Conflict-Up", "$95", "$172.82", "$165.10", "+23.3%", "15%"],
    ["Bull", "$100", "$196.42", "$177.69", "+40.1%", "20%"],
    ["Prob-Weighted", "--", "$146.85", "--", "+4.8%", "100%"],
  ]}
  caption="DCF and EV/EBITDA outputs remain tightly grouped across scenarios, which makes the valuation framework more credible."
/>
...
<ResearchTable
  headers={["WTI $/bbl", "WACC 7.5%", "WACC 8.0%", "WACC 8.5%", "WACC 9.0%", "WACC 9.5%"]}
  rows={[
  ...
  caption="The matrix is a directional overlay against the base operating model, so use the move between cells as the signal rather than the absolute level."
/>
...
<ResearchTable
  headers={["Parameter", "Value", "Context"]}
  rows={[
...
<StatGrid
  items={[
    { label: "Total Production", value: "1,397 MBoed", detail: "Includes full-year Encino contribution" },
    { label: "Total Revenue", value: "$22.2B", detail: "Base-case 2026 estimate" },
    { label: "EBITDA Margin", value: "70.5%", detail: "Base-case operating model" },
    { label: "WTI Breakeven", value: "$50/bbl", detail: "Covers capital plan and regular dividend", tone: "positive" },
  ]}
/>

<ResearchTable
  headers={["Sensitivity reference", "Value", "Why it matters"]}
  rows={[
  ...
  caption="Sensitivity references are drawn from EOG's disclosed 2026 planning assumptions."
/>
